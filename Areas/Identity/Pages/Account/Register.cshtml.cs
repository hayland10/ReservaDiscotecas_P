...
namespace ReservaDiscotecas_P.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            [Required]
            [StringLength(100, ErrorMessage="Maximo de caracteres alcanzado (100)")]
            [Display(Name = "Nombre")]
            public string Name { get; set; }

            [Required]
            [StringLength(100, ErrorMessage = "Maximo de caracteres alcanzado (10)")]
